...
class XLWrite {
       private XLWrite() {
        ...
        public static void writeXlsStatistics(List<Stat> statisticsList,
            ...
            for (Stat statistics : statisticsList) {
                Row dataRow = statisticsSheet.createRow(rowNumber++);
                Cell profileCell = dataRow.createCell(0);
                profileCell.setCellValue(statistics.getProfile().getLabel());
